...
logs_dir = '/content/drive/MyDrive/AI Project/Log2'
# %tensorboard --port 6007 --logdir "{logs_dir}"

import numpy as np

# Load the pre-trained models
model1 = tf.keras.models.load_model('model1.h5')  # Replace with the actual path
model2 = tf.keras.models.load_model('model2.h5')  # Replace with the actual path
model3 = tf.keras.models.load_model('model3.h5')  # Replace with the actual path

# Load your test data and preprocess it if necessary
test_data =
...
# Ensemble predictions (you can choose different strategies, e.g., simple average)
